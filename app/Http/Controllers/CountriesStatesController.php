...
class CountriesStatesController extends Controller
{
  ...
  {
    $messages = [
			'iso_code.required' => __('validation.required', ['attribute' => __('misc.iso_code')]),
			'iso_code.unique' => __('validation.unique', ['attribute' => __('misc.iso_code')]),
		];
    ...
    return redirect('panel/admin/countries')->withSuccessMessage(__('admin.success_add'));
  }//<--- End Method
  ...
  public function updateCountry(Request $request)
  {
    ...
    return redirect('panel/admin/countries')->withSuccessMessage(__('admin.success_update'));
  }//<--- End Method
  ...
  public function addState(Request $request)
  {
    ...
    return redirect('panel/admin/states')->withSuccessMessage(__('admin.success_add'));
  }//<--- End Method
  ...
  public function updateState(Request $request)
  {
    ...
    return redirect('panel/admin/states')->withSuccessMessage(__('admin.success_update'));
  }//<--- End Method
