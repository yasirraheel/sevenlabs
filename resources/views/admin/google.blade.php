			...
			<div class="card shadow-custom border-0">
				<div class="card-body p-lg-5">
					...
					<form method="POST" action="{{ url('panel/admin/google') }}" enctype="multipart/form-data">
						...
						<div class="row mb-3">
							<label class="col-sm-2 col-form-labe text-lg-end">Google Adsense (Index)</label>
							<div class="col-sm-10">
								<textarea class="form-control" name="google_adsense_index"
									rows="4">{{ $settings->google_adsense_index }}</textarea>
							</div>
						</div>

						<div class="row mb-3">
							<label class="col-sm-2 col-form-labe text-lg-end">Google Adsense</label>
							<div class="col-sm-10">
								<textarea class="form-control" name="google_adsense"
