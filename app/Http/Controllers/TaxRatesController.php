...
class TaxRatesController extends Controller
{
  ...
  {
    $messages = [
      'percentage.required' => __('validation.required', ['attribute' => __('misc.percentage')]),
      'percentage.numeric' => __('validation.numeric', ['attribute' => __('misc.percentage')]),
      'percentage.min' => __('validation.min', ['attribute' => __('misc.percentage')]),
      'percentage.max' => __('validation.max', ['attribute' => __('misc.percentage')]),
    ];
    ...
    return redirect('panel/admin/tax-rates')
        ->withSuccessMessage(__('misc.success_add_tax'));
