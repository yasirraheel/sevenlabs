...
@section('content')
    ...
    <a class="text-reset" href="{{ url('panel/admin') }}">{{ __('admin.dashboard') }}</a>
      ...
      <span class="text-muted">{{ __('admin.custom_css_js') }}</span>
...
<div class="content">
    ...
    <div class="alert alert-success alert-dismissible fade show" role="alert">
		...
		@include('errors.errors-forms')
            ...
            <div class="row mb-3">
		          <label class="col-sm-2 col-form-labe text-lg-end">{{ __('admin.custom_css') }}</label>
		          <div class="col-sm-10">
            ...
            <div class="row mb-3">
		          <label class="col-sm-2 col-form-labe text-lg-end">{{ __('admin.custom_js') }}</label>
		          <div class="col-sm-10">
