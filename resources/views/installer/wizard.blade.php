            ...
            <div class="row justify-content-center">
              <div class="col-lg-5">
                <div class="card bg-light shadow border-0">
                  ...
                  <!-- SuccessInstaller -->
                  <div class="card-header bg-white display-none py-4" id="SuccessInstaller">
                    ...
                    <small class="d-block text-center w-100 mt-2">Login with these credentials.</small>
                    ...
                    <div class="w-100 text-center mt-3">
                      ...
                      <small class="d-block text-center w-100 mt-2">* Remember to change the password and email.</small>
                ...
                <div class="card-header bg-white py-4" id="headerRequirements">
                  ...
                  <small class="d-block text-center w-100 mt-2">Server Requirements</small>
                </div>

                <!-- headerSetupDatabase -->
                <div class="card-header bg-white py-4 display-none" id="headerSetupDatabase">
                  <h4 class="text-center mb-0 font-weight-bold">
                    Database and App
                  </h4>
                  <small class="d-block text-center w-100 mt-2">Setup Database and App</small>
                </div>
                  ...
                  <!-- Database setup -->
                  <div class="card-body px-lg-5 py-lg-5 display-none" id="containerSetupDatabase">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="input-group mb-3">
                          <span class="input-group-text text-muted bg-transparent"><i class="fa fa-database"></i></span>
                      ...
                      <div class="col-md-6">
                        <div class="input-group mb-3">
                          <span class="input-group-text text-muted bg-transparent"><i class="fa fa-user"></i></span>
                          <input class="form-control" required value="{{old('username')}}" placeholder="Username" name="username" type="text">
                        </div>
                      </div>
                      ...
                      <div class="input-group mb-3">
                        <span class="input-group-text text-muted bg-transparent"><i class="fa fa-database"></i></span>
                        <input class="form-control" required value="{{old('host')}}" placeholder="Host" name="host" type="text">
                        <small class="text-muted d-block w-100">For example: <em>127.0.0.1</em> or <em>localhost</em></small>
                      </div>

                      <div class="input-group mb-3">
                        <span class="input-group-text text-muted bg-transparent"><i class="fa fa-key"></i></span>
                      ...
                      <div class="input-group mb-3">
                        ...
                        <small class="text-muted d-block w-100">For example: <em>GEO ENTERPRISES</em></small>
                      </div>

                      <div class="input-group mb-3">
                        <span class="input-group-text text-muted bg-transparent"><i class="fa fa-link"></i></span>
                        <input class="form-control" required value="{{old('app_url')}}" placeholder="App URL" name="app_url" type="text">
                        <small class="text-muted d-block w-100">The App URL must be as follows: <em>{{url('/')}}</em></small>
                      </div>

                      <div class="input-group mb-3">
                        <span class="input-group-text text-muted bg-transparent"><i class="fa fa-envelope"></i></span>
                        <input class="form-control" required value="{{old('email_admin')}}" placeholder="Email Admin" name="email_admin" type="text">
                        <small class="text-muted d-block w-100">For Example: <em>no-reply@yoursite.com</em></small>
                      </div>
