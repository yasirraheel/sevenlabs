...
@section('content')
    ...
    <a class="text-reset" href="{{ url('panel/admin') }}">{{ __('admin.dashboard') }}</a>
      ...
      <a class="text-reset" href="{{ url('panel/admin/countries') }}">{{ __('admin.countries') }}</a>
			<i class="bi-chevron-right me-1 fs-6"></i>
		        ...
		        <div class="row mb-3">
		          ...
		          <div class="col-sm-10">
		            <input value="{{ $country->country_code }}" name="iso_code" type="text" class="form-control">
								<small class="d-block">{{ __('misc.iso_code_country') }} <a href="https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2" target="_blank">(ISO 3166-1 alpha-2) <i class="bi-box-arrow-up-right ms-1"></i></a></small>
		          </div>
		        </div>
