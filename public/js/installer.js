...
$(document).on('click','#nextDatabase',function(s) {
 ...
 $('#containerSetupDatabase, #headerSetupDatabase').show();
	...
	element.html('<i class="spinner-border spinner-border-sm align-middle me-1"></i> Installing...');
...
var element = $(this);
element.attr({'disabled' : 'true'});
element.html('<i class="spinner-border spinner-border-sm align-middle me-1"></i> Please wait...');
