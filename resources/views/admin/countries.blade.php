...
@section('content')
    ...
    <a class="text-reset" href="{{ url('panel/admin') }}">{{ __('admin.dashboard') }}</a>
      ...
      <span class="text-muted">{{ __('admin.countries') }}</span>
							...
							@if ($countries->count() !=  0)
								...
								@foreach ($countries as $country)
									<tr>
										...
										<td>
											<a href="{{ url('panel/admin/countries/edit', $country->id) }}" class="text-reset fs-5 me-2">
												<i class="far fa-edit"></i>
											</a>

											<form action="{{ url('panel/admin/countries/delete', $country->id) }}" method="POST" class="d-inline-block align-top">
												@csrf
