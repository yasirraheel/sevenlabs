      ...
      @include('errors.errors-forms')
			...
			<div class="card shadow-custom border-0">
		        ...
		        <div class="row mb-3">
		          ...
		          <div class="col-sm-10">
		            <input value="{{ $plan->credits }}" required name="credits" type="number" min="1" class="form-control" placeholder="1000">
		          </div>
		        </div>
		          ...
		          <div class="col-sm-10">
		            <select name="duration" class="form-select">
									<option @if ($plan->duration == 'month') selected @endif value="month">{{ __('admin.month') }}</option>
									<option @if ($plan->duration == 'year') selected @endif value="year">{{ __('admin.year') }}</option>
		           </select>
		          </div>
		        </div><!-- end row -->
				...
				<fieldset class="row mb-3">
		          ...
		          <div class="col-sm-10">
		            <div class="form-check form-switch form-switch-md">
		             <input class="form-check-input" type="checkbox" @if ($plan->unused_credits_rollover) checked @endif name="unused_credits_rollover" value="1" role="switch">
		           </div>
		          </div>
		        </fieldset><!-- end row -->				
