...
@section('content')
    ...
    <a class="text-reset" href="{{ url('panel/admin') }}">{{ __('admin.dashboard') }}</a>
      ...
      <i class="bi-chevron-right me-1 fs-6"></i>
      <span class="text-muted">{{ __('misc.bank_transfer') }}</span>
  </h5>
		        ...
		        <div class="row mb-3">
		          ...
		          <div class="col-sm-10">
		            <input value="{{ $data->fee }}" name="fee" type="text" class="form-control">
						...
						<div class="row mb-3">
		          <label class="col-sm-2 col-form-label text-lg-end">{{ __('misc.flat_rate') }} ({{$settings->currency_symbol}})</label>
		          <div class="col-sm-10">
		            <input value="{{ $data->fee_cents }}" name="fee_cents" type="text" class="form-control">
						...
						<div class="row mb-3">
		          <label class="col-sm-2 col-form-label text-lg-end">{{ __('misc.bank_details') }}</label>
		          <div class="col-sm-10">
